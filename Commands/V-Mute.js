...
module.exports.run = async(client, message, args, embed) => {
    ...
    if (!member || !zaman || !sebep) return message.channel.send(embed.setDescription(`${message.member}, Hatalı kullanım. Örnek: **${ayar.bot.botPrefix}vmute @yunuz/ID [Time] [Reason]**`)).sil(7)
...
exports.config = {
    name: "vmute",
    usage: `${ayar.bot.botPrefix}vmute [@yunuz/ID] [Time] [Reason]`,
    guildOnly: true,
